...
public class SDOKPSPublicSoap
{
    ...
    public SDOKPSPublicSoap(){}

    public SDOKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SDOKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SDOExtendedSoapSerializationEnvelope envelope= new SDOExtendedSoapSerializationEnvelope(SDOExtendedSoapSerializationEnvelope.VER11);
