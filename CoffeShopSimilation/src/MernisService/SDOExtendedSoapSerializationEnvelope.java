...
public class SDOExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SDODateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SDOStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SDODateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SDODateTimeConverter dateTimeConverter = new SDOStandardDateTimeConverter();

    public SDOExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SDOExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SDOMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SDOHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SDOExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SDOHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
